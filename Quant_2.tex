...
\item \loud{Lloy algorithm: } Iterative algorithm to approximately realize centroid and nearest neighbor condition. 
\item Optimal quantizer often called \loud{Lloy quantizer}. 
\eit
...
\bit
\item At high rates, rate-distortion performance of Fixed Length and of Entropy-Constreained Lloyd quantizer can be computed \loud{explicitly}.
...
\bit
\item \STRUC{By high-rate approximation of MSE for Lloy quantizer: } 
...
\begin{frame}{Proof of Gish an Pierce approximation I}
\loud{Proof of Gish an Pierce approximation:}
\bit 
